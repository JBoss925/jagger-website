...
export const ojamlPaper: PaperDocument = {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "The current scope is finite: top-level and nested modules, local type declarations, abstract type signatures, and value signatures are supported, but file imports, concrete signature type manifests, functors, exceptions, and garbage collection are not."
                    ]
                }
            ],
        },
  ...
  println "Hello, OJaml!"`,
                ...
                },
                {
                    ...
                    caption: "A program is a list of declarations; modules group values, types, and nested modules under qualified names, module types specify required abstract types and values, and open declarations expose namespace members by short name."
                },
                {
                    kind: "paragraph",
  ...
  Map.get m "one"`,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "Module tests cover parsing, qualified member calls, user-defined opens, module type declarations, abstract type signatures, polymorphic val signature ascription, opened module-local types and constructors, local shadowing, sibling references, closures that capture module sibling values, duplicate diagnostics, unknown opens, missing signature members, mismatched signature types, and nested-module behavior.",
...
tests/*.test.ts     positive runtime tests and negative checker tests`,
                ...
                },
                {
                    kind: "bullets",
                    items: [
                        "Extending modules further requires file imports, concrete signature type manifests, functors, and richer namespace export rules beyond the current compile-time module surface.",
