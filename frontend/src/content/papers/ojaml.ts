  ...
  | Error code -> code`,
        ...
        },
        {
            ...
            blocks: [
                {
                    kind: "paragraph",
                    text: "OJaml chooses a compact compiler over a complete OCaml clone. The current surface demonstrates inference, top-level and local function recursion, high-arity closures, sequencing, forward pipelines, tuples, tuple projection, record and algebraic data type declarations with type parameters, value annotations, function parameter annotations, top-level opens for built-in stdlib namespaces, structural records, field access, tuple/record/list/array/set/map/constructor destructuring, collections, pattern matching, WebAssembly emission, and editor tooling, but it does not yet include user-defined modules, file imports, exceptions, or a garbage collector."
                },
                {
                    kind: "paragraph",
