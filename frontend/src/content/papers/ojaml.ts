  ...
  PListNil | PListCons | PWildcard | PVar`,
        ...
        },
        {
            ...
            blocks: [
                {
                    kind: "paragraph",
                    text: "OJaml uses a Hindley-Milner-style constraint system. Types are primitives, type variables, applications for tuples/records/arrays/lists/sets/maps, nominal variants with type arguments, and function types. Record type declarations add named record shapes to the checker environment; algebraic data type declarations add nominal variant type constructors and constructor bindings. Module-local types and constructors are stored under qualified names, while declarations inside the same module receive short-name aliases for sibling and enclosing module types. Value and function parameter annotations resolve those names and unify the annotated position with the declared shape. Checking walks the AST, creates fresh type variables where information is not known yet, and unifies constraints as expressions demand relationships between values."
                },
                {
                    kind: "paragraph",
