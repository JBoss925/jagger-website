    ...
    sections: [
        {
            ...
            blocks: [
                ...
                {
                    kind: "paragraph",
                    text: "The optimizer doubles as a debugging surface. Selection pressure, mutation rate, population size, and environmental difficulty are usually hidden inside algorithm logs. Here, each setting changes the shape of the paths on screen."
                },
                {
                    kind: "paragraph",
                    text: "The project is intentionally not trying to prove that a genetic algorithm is the best way to solve projectile motion. A closed-form or numerical solver could find many of these shots more directly. Projectile motion gives the algorithm a visible success condition: exploration, exploitation, lucky hits, premature convergence, and recovery from changed conditions appear as geometry rather than as abstract fitness numbers."
                },
                {
                    kind: "bullets",
                    items: [
        ...
        },
        {
            ...
            blocks: [
                ...
                {
                    kind: "paragraph",
                    text: "That discontinuity is deliberate. Near misses should guide the population before it discovers the target, but once any genome actually overlaps the target, the search should rapidly prefer true hits over merely elegant arcs. The early-hit bonus then breaks ties among successful shots by favoring simpler, faster trajectories."
                },
                {
                    kind: "equation",
                    label: "Miss score",
...
evaluate the next generation`,
                ...
                {
                    kind: "paragraph",
                    text: "Random resets occupy roughly eight percent of the next population. In a draggable scene, the target or field can move abruptly; the reset tail prevents a population converged around the old shot from becoming the only genetic material available for the new problem."
                }
            ],
        },
        {
...
reset solved streak`,
        ...
        },
        {
            ...
            blocks: [
                {
                    kind: "paragraph",
                    text: "The implementation keeps the genetic algorithm in a pure simulation module and the visual playback in the React page. The evolution loop can be tested without running animation timing, drag handlers, or SVG playback."
                },
                {
                    kind: "paragraph",
                    text: "A deterministic Mulberry32 random source is used per seed and generation. A generation can be reproduced exactly, while rerolling the seed or changing the environment still creates a genuinely new run."
                },
                {
                    kind: "bullets",
                    items: [
