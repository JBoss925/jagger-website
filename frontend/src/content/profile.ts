  ...
  experience: [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Built on AWS services including DynamoDB, RDS/PostgreSQL, SQS, Lambda, Lambda@Edge, Route 53, and nginx reverse proxies for platform routing, domains, asynchronous work, and deployment flows.",
