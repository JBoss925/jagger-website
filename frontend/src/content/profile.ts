  ...
  projects: [
    {
      ...
      title: "OJaml",
      description:
        "An OCaml-inspired language and compiler built end to end in TypeScript with **lexing, recursive-descent parsing, Hindley-Milner-style inference, polymorphic functions, typed standard-library schemes, nested modules/opens, tuples, records, polymorphic ADTs, structural pattern matching, polymorphic collections, and WebAssembly emission**.",
      impact:
        "The browser-native Monaco playground and Node CLI run the same pipeline through WABT, with diagnostics, hovers, completions, closure conversion, high-arity and staged function values, floats, strings, nested modules/opens, sequencing/pipelines, tuples, polymorphic ADTs, records, collection patterns, sets, maps, runtime access checks, and compiler-specialization coverage.",
      stack: [
        "OJaml",
        "TypeScript",
        "React",
