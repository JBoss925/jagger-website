  ...
  projects: [
    {
      ...
      impact:
        "The browser-native Monaco playground and Node CLI run the same pipeline through WABT, with diagnostics, hovers, completions, closure conversion, high-arity function values, floats, strings, tuples, tuple projection, records, array patterns, lists, sets, maps, runtime access checks, and compiler-specialization coverage.",
      stack: [
        "OJaml",
        "TypeScript",
        "React",
