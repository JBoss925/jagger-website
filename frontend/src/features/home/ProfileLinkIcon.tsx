...
export default function ProfileLinkIcon({ label }: ProfileLinkIconProps) {
  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm.1 15.6a1.17 1.17 0 1 1 0 2.34 1.17 1.17 0 0 1 0-2.34Zm2.83-5.54c-.34.5-.94.98-1.77 1.48-.56.35-.72.56-.72 1.18v.45h-1.96v-.54c0-1.24.48-1.9 1.5-2.52.73-.44 1.1-.75 1.29-1.04.17-.25.25-.56.25-.94 0-.47-.14-.83-.43-1.08-.3-.27-.7-.4-1.22-.4-.55 0-1 .17-1.35.5-.35.32-.6.8-.73 1.43l-1.86-.56c.22-.98.68-1.76 1.38-2.33.7-.58 1.57-.87 2.62-.87 1.1 0 1.98.29 2.63.88.66.58.99 1.38.99 2.4 0 .78-.2 1.43-.62 1.96Z"
        fill="currentColor"
      />
    </svg>
  );
