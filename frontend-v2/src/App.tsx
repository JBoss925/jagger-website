...
function homeSiteHref() {
  if (import.meta.env.DEV) {
    return `${window.location.protocol}//${window.location.hostname}:5173`;
  }

  return "https://jaggerbrulato.com";
}
